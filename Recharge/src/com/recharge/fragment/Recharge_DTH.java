...
public class Recharge_DTH extends Fragment {
	private TextView txt_provider, txt_state;

	public static Recharge_DTH newInstance(int page, String title) {
		Recharge_DTH fragmentFirst = new Recharge_DTH();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.recharge_dth_fragment, container,
				false);
	...
	public void open_provide_dialog() {
		final CharSequence[] items = { "Dish TV", "Tata Sky",
				"Reliance Big TV", "Videocon D2H", "Sun Direct", "Airtel DTH" };
